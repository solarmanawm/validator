...
describe('String min length validation', () => {
    ...
    test('Empty', () => {
        ...
        expect(errors[DATA_KEY][0]).toBe(Helpers.getErrorMessage(TYPE, ERROR_MESSAGES[TYPE], MIN_LENGTH_VALUE));
    });
...
describe('Array min length validation', () => {
    const TYPE = 'minLength';
    const DATA_KEY = 'source';
...
describe('Wrong type min length validation', () => {
    const TYPE = 'minLength';
    const DATA_KEY = 'source';
    const MIN_LENGTH_VALUE = 3;
    const schema = {
